...
(helm-mode 1)
;; Set custom font for org mode buffers only
;; (defun my-buffer-face-mode-variable ()
;;   "Set font to a variable width (proportional) fonts in current buffer"
;;   (interactive)
;;   (setq buffer-face-mode-face '(:family "Lucinda Grande"))
;;   (buffer-face-mode))
...
(custom-set-variables
 ...
 '(org-agenda-files
   '("~/Notes/Career-Growth.org" "~/Notes/Emac-Notes.org" "~/Notes/Life.org" "~/Notes/Media.org" "~/Notes/Meditation.org" "~/Notes/Work.org" "~/Notes/Yi Jing.org" "~/Notes/Yoga.org"))
 '(package-selected-packages '(ledger-mode org-gcal doom-themes adaptive-wrap)))
